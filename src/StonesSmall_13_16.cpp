...
StonesSmall_13_16::StonesSmall_13_16(){
...
void StonesSmall_13_16::sequence1(){
...
void StonesSmall_13_16::sequence2(){
...
void StonesSmall_13_16::debugMode(){
...
// Draw white circles over all stepping stones and display their position numbers
    ...
    for(int i = 0; i < stones.size(); i ++){
        ...
        ofDrawCircle(origins[i], rad);
        ofSetColor(0);
        font.drawString("S" + ofToString(i + 13),origins[i].x - 100, origins[i].y); // offset to print i as 13-16
        ofPopStyle();
