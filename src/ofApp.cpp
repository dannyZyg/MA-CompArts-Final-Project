...
//    }
    ...
    cout << "seq trig = " << environmentTwo.enviro.sequenceTrigger << endl;
    cout << "e2 active " << environmentTwo.enviro.sequenceActive << endl;
    cout << environmentTwo.enviro.trigger << endl;
