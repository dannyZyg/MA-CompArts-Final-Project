...
StonesSmall_5_8::StonesSmall_5_8(){
...
void StonesSmall_5_8::sequence1(){
...
void StonesSmall_5_8::debugMode(){
...
// Draw white circles over all stepping stones and display their position numbers
    ...
    for(int i = 0; i < stones.size(); i ++){
        ...
        ofDrawCircle(origins[i], rad);
        ofSetColor(0);
        font.drawString("S" + ofToString(i + 5),origins[i].x - 100, origins[i].y);// offset to print i as 5-8
        ofPopStyle();
