...
void StonesMed_1_4::debugMode(){
    ...
    for(int i = 0; i < stones.size(); i ++){
        ...
        ofDrawCircle(origins[i], rad);
        ofSetColor(0);
        font.drawString("M" + ofToString(i + 1),origins[i].x - 100, origins[i].y);
        ofPopStyle();
